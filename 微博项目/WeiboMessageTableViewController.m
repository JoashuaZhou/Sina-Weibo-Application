//
//  WeiboMessageTableViewController.m
//  微博项目
//
...
@interface WeiboMessageTableViewController ()

@end

@implementation WeiboMessageTableViewController
// 234 103 7
- (void)viewDidLoad
{
    [super viewDidLoad];
...
//    self.navigationItem.rightBarButtonItem.tintColor = [UIColor colorWithRed:234/255.0 green:103/255.0 blue:7/255.0 alpha:1.0];
}
